      ...
      <section className="px-4 pt-6 pb-8 sm:px-6 lg:px-10 lg:pt-8 lg:pb-10">
        <div className="mx-auto max-w-[1500px]">
          <p className="text-sm text-gray-500">
            Home <span className="mx-2 text-gray-300">/</span> Men
          </p>
          ...
          <div className="mt-4 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="relative overflow-hidden rounded-[32px] border border-black/5 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
              ...
              <div className="absolute bottom-0 left-0 h-32 w-32 rounded-full bg-cyan-100/50 blur-3xl" />
              ...
              <div className="relative">
                ...
                <p className="mt-4 max-w-2xl text-sm leading-7 text-gray-600 sm:text-base">
                  Explore men&apos;s sneakers across lifestyle, running,
                  football, basketball, and more. Use filters to quickly find
                  the style, brand, color, and price range that suits you.
                </p>

                <div className="mt-6 flex flex-wrap items-center gap-3">
                  <div className="rounded-full bg-[#111] px-5 py-2 text-sm font-semibold text-white">
                    Everyday to Performance
                  </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              <div className="rounded-[28px] bg-[#111] p-6 text-white shadow-sm">
                ...
                <h2 className="mt-3 text-2xl font-bold">
                  Lifestyle, running, football and more
                </h2>
                <p className="mt-2 text-sm leading-6 text-white/80">
                  Browse versatile styles made for daily wear, sport, and
                  training.
                </p>
              </div>
              ...
              <div className="rounded-[28px] border border-black/5 bg-white p-6 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-gray-600">
                  Narrow down men&apos;s sneakers by brand, color, category, and
                  price in one place.
                </p>
              </div>
            </div>
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 sm:text-base">
                  Highlighted pairs from the men&apos;s collection.
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-600 sm:text-base">
                    Browse all men&apos;s sneakers and open any item to view more
                    details.
                  </p>
                </div>
